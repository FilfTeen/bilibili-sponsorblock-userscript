...
BSC v0.3.7 是运行在 Tampermonkey 中的 Bilibili 增强 userscript。技术目标：
...
- `src/platform`：Tampermonkey 授权 API 和页面桥接。
...
发布前还需要 Safari 主窗口人工验收，覆盖至少视频页、评论区、动态页、首页/搜索卡片和控制台。
