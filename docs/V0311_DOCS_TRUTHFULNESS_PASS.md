...
This pass was written while QoL Core v0.3.10 was the published baseline. v0.3.11 kept these conservative boundaries and turned the evidence-hardening work into release documentation.
...
- v0.3.11 release prep preserves the same conservative MBGA boundaries. Later release decisions should continue to require Safari main-window acceptance and release validation.
