...
`v0.3.9` 是对 `v0.3.8` 迁移版的补丁发布：修复 QoL Core 控制台里 select / 卡片的 pointer focus 残留与诊断开关 hover/focus 反馈问题。`v0.3.8` 仍是仓库重命名和 Tampermonkey 更新链路迁移版本。
...
- [v0.3.7 / v0.3.8 / v0.3.9 分支健康记录](./docs/BRANCH_HEALTH_V037.md)：发布后 main、tag、integration 和历史分支状态。
